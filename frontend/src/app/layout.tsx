...
export const metadata: Metadata = {
  ...
  description:
    'A native Rust ZK verifier on Polkadot powering private apps, context-bound proofs, and reusable privacy flows via PolkaVM.',
  openGraph: {
    title: 'ZKNative',
    description: 'Private apps, stealth claims, and reusable privacy flows powered by Rust ZK proofs on Polkadot Hub',
  ...
  return (
    <html lang="en">
      <body className="bg-polkadot-black text-white min-h-screen font-sans antialiased">
        <AppProviders>
          <header className="border-b border-polkadot-gray px-4 py-4 sm:px-6">
            <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <nav className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-gray-400 sm:gap-6">
          ...
          <footer className="border-t border-polkadot-gray px-4 py-4 text-center text-xs text-gray-600 sm:px-6">
            ZKNative — private apps and native Rust verification on Polkadot Hub ·{' '}
            <a
